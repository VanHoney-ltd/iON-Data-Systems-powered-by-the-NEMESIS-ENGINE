# MINiOS Refactored Codebase — Complete Source Review

**Crate:** minios v2.1.0

**Generated:** 2026-04-24T04:40:22-05:00
...
[[bin]]
name = "minios_ui"
path = "src/ui_shell/main.rs"
required-features = ["gtk_shell"]

[[bin]]
name = "minios-export"
path = "src/ui_export.rs"

[features]
default = []
gtk_shell = ["gtk4", "relm4"]
full = ["gtk_shell"]
...
rpassword = "7.3"
regex = "1.11"
rusqlite = { version = "0.29", features = ["backup", "bundled"] }
serde = { version = "1.0", features = ["derive"] }
serde_json = "1.0"
sha1 = "0.10"
sha2 = "0.10"
strsim = "0.11"
tokio = { version = "1.37", features = ["io-util", "macros", "process", "rt-multi-thread", "sync", "time"] }
thiserror = "1.0"
...
gtk4 = { version = "0.11.2", optional = true }
relm4 = { version = "0.11.0", optional = true, features = ["macros"] }
toml = "0.8"
tar = "0.4"
...
## src/ui/style.css.template

```css
window.stygion-shell {
    background: linear-gradient(180deg, #e7db9f 0%, #d8ca86 100%);
    color: #1a1a1a;
}
...
.sidebar-scroll {
    border-right: 1px solid rgba(255, 196, 0, 0.45);
}
...
.sidebar-brand {
    padding: {outer_padding}px {outer_padding}px {card_gap}px;
...
.nav-section {
    ...
    padding: {outer_padding}px {outer_padding}px 4px;
...
.topbar {
    ...
    padding: {outer_padding}px {content_padding}px;
}

.content {
    background: linear-gradient(180deg, #f7f0c9 0%, #eee2ae 100%);
...
.card-header {
    ...
    padding: {outer_padding}px {card_padding}px;
}
...
.cerberus-message-row {
    padding: 2px 0;
}

.cerberus-contact-row {
    padding: 2px 0;
}

.cerberus-contact-label {
    color: #1a1a1a;
    font-family: "IBM Plex Sans", "Noto Sans", sans-serif;
    font-size: {body_size}px;
    font-weight: 600;
...
.cerberus-contact-row:hover {
    background: rgba(241, 188, 0, 0.15);
}

.cerberus-attachments-header {
    color: #1a1a1a;
    font-family: "IBM Plex Sans", "Noto Sans", sans-serif;
    font-size: {card_title_size}px;
    font-weight: 600;
...
.cerberus-contact-dropdown > title {
    color: #1a1a1a;
}

.cerberus-selected-contact-list {
    background: #ffffff;
    border: 1px solid #cccccc;
    padding: 6px;
}

.cerberus-selected-contact-row {
    padding: 2px 0;
}

.cerberus-selected-contact-btn {
...
.cerberus-selected-contact-btn:hover {
    background: rgba(241, 188, 0, 0.15);
}

.cerberus-contact-checkbox {
    color: #1a1a1a;
    font-family: "IBM Plex Sans", "Noto Sans", sans-serif;
    font-size: {body_size}px;
    font-weight: 600;
...
*End of MINiOS Refactored Codebase*
